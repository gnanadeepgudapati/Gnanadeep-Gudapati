...
// SAFE STRING REPLACEMENT HELPER
...
indexCss = replaceAll(indexCss, 'background-color: #0f0e0d;', 'background-color: #171717;');
indexCss = replaceAll(indexCss, 'color: #D6D3D1;', 'color: #D6D3D1;'); // Ensure Stone-300
...
// Swap Indigo/Sky to Teal/Emerald (we only swap the specific classes we know we added)
